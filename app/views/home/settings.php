<link rel="stylesheet" href="<?php echo $this->asset('/app/html/css/admin/settings.css'); ?>">
<main class="settings-page">
    <form class="settings-form" action="<?php echo $this->getUrl('admin/saveSettings'); ?>" method="post">
        <!-- 基本信息设置 -->
