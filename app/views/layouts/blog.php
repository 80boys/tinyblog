...
<head>
    ...
    <!-- JavaScript 依赖 -->
    <script src="<?= $this->asset('/app/html/js/interact.min.js') ?>"></script>
    <script src="<?= $this->asset('/app/html/js/highlight/highlight.min.js') ?>"></script>

    <!-- 自定义脚本 -->
    <script src="<?= $this->asset('/app/html/js/blog/nav.js') ?>"></script>
    <script src="<?= $this->asset('/app/html/js/blog/code-highlight.js') ?>"></script>
    <script src="<?= $this->asset('/app/html/js/blog/image-viewer.js') ?>"></script>
</head>
