            ...
            <section class="form-container">
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="site_description" name="site_description" required><?php
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="footer_text" name="footer_text"><?php
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="analytics_code" name="analytics_code"><?php
                                                                            echo htmlspecialchars($settings['analytics_code'] ?? '');
                                                                            ?></textarea>
